...
module.exports = (sequelize, DataTypes) => {
  var Model = sequelize.define('employee', {
    ...
    reportingManagerId: DataTypes.INTEGER,
    created: {
      type: DataTypes.DATE,
  ...
  Model.associate = function (models) {
    ...
    this.reportingManagerId = this.hasMany(models.employee, { foreignKey: 'reportingManagerId' });
    this.reportingManagerId = this.belongsTo(models.employee, { as: 'reportingManager', foreignKey: 'reportingManagerId' });
  };
